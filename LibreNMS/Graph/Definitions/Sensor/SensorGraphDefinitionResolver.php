...
/**
 * SensorGraphDefinitionResolver.php
 *
...
class SensorGraphDefinitionResolver implements GraphDefinitionResolver
{
    private const PREFIX = 'sensor_';
    ...
    public function definitionFor(string $graphType): GraphDefinition
    {
        ...
        return new SensorGraph($sensorClass);
    }
